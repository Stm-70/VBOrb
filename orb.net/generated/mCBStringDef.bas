Attribute VB_Name = "mCBStringDef"
...
Public Const TypeId As String = "IDL:omg.org/CORBA/StringDef:1.0"

'Helper
Public Function narrow(ByVal Obj As cOrbObject) As cCBStringDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
        Set narrow = Nothing
    Else
        Dim oObj As cOrbObject
        Set oObj = New cCBStringDef
...
'Helper
Public Function uncheckedNarrow(ByVal Obj As cOrbObject) As cCBStringDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
