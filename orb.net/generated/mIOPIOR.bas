...
'struct ::IOP::IOR
Public Const TypeId As String = "IDL:omg.org/IOP/IOR:1.0"
...
Public Function extractFromAny(ByVal oAny As cOrbAny) As cIOPIOR
    Dim oStruct As cIOPIOR
    Set oStruct = New cIOPIOR
    Call oStruct.initByAny(oAny)
    Set extractFromAny = oStruct
End Function

'Helper, struct.writeMe() -> oAny.initByReadValue()
Public Function cloneAsAny(ByVal oStruct As cIOPIOR) As cOrbAny
    On Error GoTo ErrHandler
    Dim oAny As cOrbAny
