Attribute VB_Name = "mCBValueMemberDef"
...
Public Const TypeId As String = "IDL:omg.org/CORBA/ValueMemberDef:1.0"

'Helper
Public Function narrow(ByVal Obj As cOrbObject) As cCBValueMemberDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
        Set narrow = Nothing
    Else
        Dim oObj As cOrbObject
        Set oObj = New cCBValueMemberDef
...
'Helper
Public Function uncheckedNarrow(ByVal Obj As cOrbObject) As cCBValueMemberDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
