Attribute VB_Name = "mIOPCodecInvalidTypeForEncoding"
...
Public Const TypeId As String = "IDL:omg.org/IOP/Codec/InvalidTypeForEncoding:1.0"
...
Public Function TypeCode() As cOrbTypeCode
    ...
    If oRecTC Is Nothing Then
        ...
        Call oRecTC.setRecTc2ExceptionTc("InvalidTypeForEncoding", oMemSeq)
    End If
    Set TypeCode = oRecTC
    Exit Function
ErrRollback:
...
Public Function extractFromAny(ByVal oAny As cOrbAny) _
    As cIOPCodecInvalidTypeForEncoding
    Dim oException As cIOPCodecInvalidTypeForEncoding
    Set oException = New cIOPCodecInvalidTypeForEncoding
    Call oException.initByAny(oAny)
    Set extractFromAny = oException
End Function

'Helper, exception.writeMe() -> oAny.initByReadValue()
Public Function cloneAsAny(ByVal oException As cIOPCodecInvalidTypeForEncoding) _
    As cOrbAny
    On Error GoTo ErrHandler
    Dim oAny As cOrbAny
