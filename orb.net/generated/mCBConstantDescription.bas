Attribute VB_Name = "mCBConstantDescription"
...
Public Const TypeId As String = "IDL:omg.org/CORBA/ConstantDescription:1.0"
...
Public Function TypeCode() As cOrbTypeCode
    ...
    If oRecTC Is Nothing Then
        ...
        oMemSeq.Item(5).name = "value"
        Set oMemSeq.Item(5).p_type = oOrb.createPrimitiveTc(11) 'VBOrb.TCAny
        'Overwrite place holder
        Call oRecTC.setRecTc2StructTc("ConstantDescription", oMemSeq)
    End If
    Set TypeCode = oRecTC
    Exit Function
ErrRollback:
...
Public Function extractFromAny(ByVal oAny As cOrbAny) As cCBConstantDescription
    Dim oStruct As cCBConstantDescription
    Set oStruct = New cCBConstantDescription
    Call oStruct.initByAny(oAny)
    Set extractFromAny = oStruct
End Function

'Helper, struct.writeMe() -> oAny.initByReadValue()
Public Function cloneAsAny(ByVal oStruct As cCBConstantDescription) As cOrbAny
    On Error GoTo ErrHandler
    Dim oAny As cOrbAny
