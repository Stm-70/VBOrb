Attribute VB_Name = "mCBCustomMarshal"
...
Public Const TypeId As String = "IDL:omg.org/CORBA/CustomMarshal:1.0"
...
Public Function TypeCode() As cOrbTypeCode
    ...
    If oRecTC Is Nothing Then
        ...
        Call oRecTC.setRecTc2ValueTc("CustomMarshal", iTypeModifier, oConcreteBase, oMemSeq)
    End If
    Set TypeCode = oRecTC
    Exit Function
ErrRollback:
