Attribute VB_Name = "mCBStructDef"
...
Public Const TypeId As String = "IDL:omg.org/CORBA/StructDef:1.0"

'Helper
Public Function narrow(ByVal Obj As cOrbObject) As cCBStructDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
        Set narrow = Nothing
    Else
        Dim oObj As cOrbObject
        Set oObj = New cCBStructDef
...
'Helper
Public Function uncheckedNarrow(ByVal Obj As cOrbObject) As cCBStructDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
