Attribute VB_Name = "mCBParameterDescription"
...
Public Const TypeId As String = "IDL:omg.org/CORBA/ParameterDescription:1.0"
...
Public Function TypeCode() As cOrbTypeCode
    ...
    If oRecTC Is Nothing Then
        ...
        oMemSeq.Item(3).name = "mode"
        Set oMemSeq.Item(3).p_type = mCB.ParameterMode_TypeCode()
        'Overwrite place holder
        Call oRecTC.setRecTc2StructTc("ParameterDescription", oMemSeq)
    End If
    Set TypeCode = oRecTC
    Exit Function
ErrRollback:
...
Public Function extractFromAny(ByVal oAny As cOrbAny) As cCBParameterDescription
    Dim oStruct As cCBParameterDescription
    Set oStruct = New cCBParameterDescription
    Call oStruct.initByAny(oAny)
    Set extractFromAny = oStruct
End Function

'Helper, struct.writeMe() -> oAny.initByReadValue()
Public Function cloneAsAny(ByVal oStruct As cCBParameterDescription) As cOrbAny
    On Error GoTo ErrHandler
    Dim oAny As cOrbAny
