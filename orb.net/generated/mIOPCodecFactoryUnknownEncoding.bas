Attribute VB_Name = "mIOPCodecFactoryUnknownEncoding"
...
Public Const TypeId As String = "IDL:omg.org/IOP/CodecFactory/UnknownEncoding:1.0"
...
Public Function TypeCode() As cOrbTypeCode
    ...
    If oRecTC Is Nothing Then
        ...
        Call oRecTC.setRecTc2ExceptionTc("UnknownEncoding", oMemSeq)
    End If
    Set TypeCode = oRecTC
    Exit Function
ErrRollback:
...
Public Function extractFromAny(ByVal oAny As cOrbAny) _
    As cIOPCodecFactoryUnknownEncoding
    Dim oException As cIOPCodecFactoryUnknownEncoding
    Set oException = New cIOPCodecFactoryUnknownEncoding
    Call oException.initByAny(oAny)
    Set extractFromAny = oException
End Function

'Helper, exception.writeMe() -> oAny.initByReadValue()
Public Function cloneAsAny(ByVal oException As cIOPCodecFactoryUnknownEncoding) _
    As cOrbAny
    On Error GoTo ErrHandler
    Dim oAny As cOrbAny
