Attribute VB_Name = "mCBSequenceDef"
...
Public Const TypeId As String = "IDL:omg.org/CORBA/SequenceDef:1.0"

'Helper
Public Function narrow(ByVal Obj As cOrbObject) As cCBSequenceDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
        Set narrow = Nothing
    Else
        Dim oObj As cOrbObject
        Set oObj = New cCBSequenceDef
...
'Helper
Public Function uncheckedNarrow(ByVal Obj As cOrbObject) As cCBSequenceDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
