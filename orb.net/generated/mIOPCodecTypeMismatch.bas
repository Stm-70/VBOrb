Attribute VB_Name = "mIOPCodecTypeMismatch"
...
Public Const TypeId As String = "IDL:omg.org/IOP/Codec/TypeMismatch:1.0"
...
Public Function TypeCode() As cOrbTypeCode
    ...
    If oRecTC Is Nothing Then
        ...
        Call oRecTC.setRecTc2ExceptionTc("TypeMismatch", oMemSeq)
    End If
    Set TypeCode = oRecTC
    Exit Function
ErrRollback:
...
Public Function extractFromAny(ByVal oAny As cOrbAny) As cIOPCodecTypeMismatch
    Dim oException As cIOPCodecTypeMismatch
    Set oException = New cIOPCodecTypeMismatch
    Call oException.initByAny(oAny)
    Set extractFromAny = oException
End Function

'Helper, exception.writeMe() -> oAny.initByReadValue()
Public Function cloneAsAny(ByVal oException As cIOPCodecTypeMismatch) As cOrbAny
    On Error GoTo ErrHandler
    Dim oAny As cOrbAny
