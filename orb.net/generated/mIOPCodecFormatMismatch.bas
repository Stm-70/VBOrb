Attribute VB_Name = "mIOPCodecFormatMismatch"
...
Public Const TypeId As String = "IDL:omg.org/IOP/Codec/FormatMismatch:1.0"
...
Public Function TypeCode() As cOrbTypeCode
    ...
    If oRecTC Is Nothing Then
        ...
        Call oRecTC.setRecTc2ExceptionTc("FormatMismatch", oMemSeq)
    End If
    Set TypeCode = oRecTC
    Exit Function
ErrRollback:
...
Public Function extractFromAny(ByVal oAny As cOrbAny) As cIOPCodecFormatMismatch
    Dim oException As cIOPCodecFormatMismatch
    Set oException = New cIOPCodecFormatMismatch
    Call oException.initByAny(oAny)
    Set extractFromAny = oException
End Function

'Helper, exception.writeMe() -> oAny.initByReadValue()
Public Function cloneAsAny(ByVal oException As cIOPCodecFormatMismatch) _
    As cOrbAny
    On Error GoTo ErrHandler
    Dim oAny As cOrbAny
