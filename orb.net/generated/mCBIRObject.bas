...
Public Const TypeId As String = "IDL:omg.org/CORBA/IRObject:1.0"

'Helper
Public Function narrow(ByVal Obj As cOrbObject) As cCBIRObject
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
        Set narrow = Nothing
    Else
        Dim oObj As cOrbObject
        Set oObj = New cCBIRObject
...
'Helper
Public Function uncheckedNarrow(ByVal Obj As cOrbObject) As cCBIRObject
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
