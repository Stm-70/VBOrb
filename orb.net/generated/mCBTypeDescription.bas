Attribute VB_Name = "mCBTypeDescription"
...
Public Const TypeId As String = "IDL:omg.org/CORBA/TypeDescription:1.0"
...
Public Function TypeCode() As cOrbTypeCode
    ...
    If oRecTC Is Nothing Then
        ...
        Call oRecTC.setRecTc2StructTc("TypeDescription", oMemSeq)
    End If
    Set TypeCode = oRecTC
    Exit Function
ErrRollback:
...
Public Function extractFromAny(ByVal oAny As cOrbAny) As cCBTypeDescription
    Dim oStruct As cCBTypeDescription
    Set oStruct = New cCBTypeDescription
    Call oStruct.initByAny(oAny)
    Set extractFromAny = oStruct
End Function

'Helper, struct.writeMe() -> oAny.initByReadValue()
Public Function cloneAsAny(ByVal oStruct As cCBTypeDescription) As cOrbAny
    On Error GoTo ErrHandler
    Dim oAny As cOrbAny
