Attribute VB_Name = "mCBNativeDef"
...
Public Const TypeId As String = "IDL:omg.org/CORBA/NativeDef:1.0"

'Helper
Public Function narrow(ByVal Obj As cOrbObject) As cCBNativeDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
        Set narrow = Nothing
    Else
        Dim oObj As cOrbObject
        Set oObj = New cCBNativeDef
...
'Helper
Public Function uncheckedNarrow(ByVal Obj As cOrbObject) As cCBNativeDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
