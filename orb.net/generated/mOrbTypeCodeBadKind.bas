Attribute VB_Name = "mOrbTypeCodeBadKind"
...
Public Const TypeId As String = "IDL:omg.org/CORBA/TypeCode/BadKind:1.0"
...
Public Function TypeCode() As cOrbTypeCode
    ...
    If oRecTC Is Nothing Then
        ...
        Call oRecTC.setRecTc2ExceptionTc("BadKind", oMemSeq)
    End If
    Set TypeCode = oRecTC
    Exit Function
ErrRollback:
...
Public Function extractFromAny(ByVal oAny As cOrbAny) As cOrbTypeCodeBadKind
    Dim oException As cOrbTypeCodeBadKind
    Set oException = New cOrbTypeCodeBadKind
    Call oException.initByAny(oAny)
    Set extractFromAny = oException
End Function

'Helper, exception.writeMe() -> oAny.initByReadValue()
Public Function cloneAsAny(ByVal oException As cOrbTypeCodeBadKind) As cOrbAny
    On Error GoTo ErrHandler
    Dim oAny As cOrbAny
