Attribute VB_Name = "mCBBadFixedValue"
'Generated by IDL2VB v123. Copyright (c) 2000-2003 Martin.Both
'Source File Name: ../include/CORBA.idl

Option Explicit

'exception ::CORBA::BadFixedValue
Public Const TypeId As String = "IDL:omg.org/CORBA/BadFixedValue:1.0"
...
Public Function extractFromAny(ByVal oAny As cOrbAny) As cCBBadFixedValue
    Dim oException As cCBBadFixedValue
    Set oException = New cCBBadFixedValue
    Call oException.initByAny(oAny)
    Set extractFromAny = oException
End Function

'Helper, exception.writeMe() -> oAny.initByReadValue()
Public Function cloneAsAny(ByVal oException As cCBBadFixedValue) As cOrbAny
    On Error GoTo ErrHandler
    Dim oAny As cOrbAny
