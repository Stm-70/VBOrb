Attribute VB_Name = "mCBRepository"
...
Public Const TypeId As String = "IDL:omg.org/CORBA/Repository:1.0"

'Helper
Public Function narrow(ByVal Obj As cOrbObject) As cCBRepository
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
        Set narrow = Nothing
    Else
        Dim oObj As cOrbObject
        Set oObj = New cCBRepository
...
'Helper
Public Function uncheckedNarrow(ByVal Obj As cOrbObject) As cCBRepository
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
