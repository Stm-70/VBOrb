Attribute VB_Name = "mCBContainedDescription"
...
Public Const TypeId As String = "IDL:omg.org/CORBA/Contained/Description:1.0"
...
Public Function TypeCode() As cOrbTypeCode
    ...
    If oRecTC Is Nothing Then
        ...
        oMemSeq.Item(0).name = "kind"
        Set oMemSeq.Item(0).p_type = mCB.DefinitionKind_TypeCode()
        Set oMemSeq.Item(1) = New cCBStructMember
        oMemSeq.Item(1).name = "value"
...
Public Function extractFromAny(ByVal oAny As cOrbAny) As cCBContainedDescription
    Dim oStruct As cCBContainedDescription
    Set oStruct = New cCBContainedDescription
    Call oStruct.initByAny(oAny)
    Set extractFromAny = oStruct
End Function

'Helper, struct.writeMe() -> oAny.initByReadValue()
Public Function cloneAsAny(ByVal oStruct As cCBContainedDescription) As cOrbAny
    On Error GoTo ErrHandler
    Dim oAny As cOrbAny
