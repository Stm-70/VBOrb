Attribute VB_Name = "mCBDataOutputStream"
...
Public Const TypeId As String = "IDL:omg.org/CORBA/DataOutputStream:1.0"
...
Public Function TypeCode() As cOrbTypeCode
    ...
    If oRecTC Is Nothing Then
        ...
        Call oRecTC.setRecTc2ValueTc("DataOutputStream", iTypeModifier, oConcreteBase, oMemSeq)
    End If
    Set TypeCode = oRecTC
    Exit Function
ErrRollback:
