...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "cCBPrimitiveDef"
...
'Target File Name: cCBPrimitiveDef.cls
...
Const sTypeId As String = "IDL:omg.org/CORBA/PrimitiveDef:1.0"
...
'readonly attribute kind
Public Property Get kind() As Long
    On Error GoTo ErrHandler
    Dim oRequest As cOrbRequest
    Set oRequest = oObjRef.request("_get_kind", False)
    Dim oIn As cOrbStream
    Call oRequest.invokeReqst(False)
    Set oIn = oRequest.OutRes
    kind = oIn.readUlong()
    Exit Property
ErrHandler:
    Call mVBOrb.VBOrb.ErrReraise(Err, "kind.Get")
End Property
