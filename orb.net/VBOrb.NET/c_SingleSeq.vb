Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("c_SingleSeq_NET.c_SingleSeq")> Public Class c_SingleSeq
	'Generated by IDL2VB v123. Copyright (c) 1999-2003 Martin.Both
	'Source File Name: ../include/CORBA.idl
	'Target File Name: c_SingleSeq.cls
	
	
	'IDL Name: sequence<float>
	
	Private seqLen As Integer
	Private seqBnd As Integer
	Private seqArr() As Single
	...
	Public Property Length() As Integer
		...
		Set(ByVal Value As Integer)
			...
			Exit Property
ErrHandler: 
			Call mVBOrb.VBOrb.ErrReraise(Err, "SingleSeq.Length.Let")
		End Set
	End Property
	...
	'index must be in the range of 0 to Length - 1
	Public Property Item(ByVal index As Integer) As Single
		Get
			On Error GoTo ErrHandler
			Item = seqArr(index)
			Exit Property
ErrHandler: 
			Call mVBOrb.VBOrb.ErrReraise(Err, "SingleSeq.Item.Get")
		End Get
		Set(ByVal Value As Single)
			...
			Exit Property
ErrHandler: 
			Call mVBOrb.VBOrb.ErrReraise(Err, "SingleSeq.Item.Let")
		End Set
	End Property
	
	Public Function getItems(ByRef Arr() As Single) As Integer
		On Error GoTo ErrHandler
		getItems = seqLen
...
ErrHandler: 
	...
	Public Sub setItems(ByRef Arr() As Single, ByVal newLen As Integer)
		On Error GoTo ErrHandler
		Me.Length = newLen
		Dim seqCnt As Integer
		For seqCnt = 0 To seqLen - 1
...
ErrHandler: 
	...
	Public Sub initByRead(ByVal oIn As cOrbStream, ByVal maxLen As Integer)
		...
		Dim seqCnt As Integer
		For seqCnt = 0 To seqLen - 1
			seqArr(seqCnt) = oIn.readFloat()
		Next seqCnt
		Exit Sub
ErrHandler: 
		Call mVBOrb.VBOrb.ErrReraise(Err, "SingleSeq.read")
	End Sub
	...
	Public Sub writeMe(ByVal oOut As cOrbStream, ByVal maxLen As Integer)
		...
		Dim seqCnt As Integer
		For seqCnt = 0 To seqLen - 1
			Call oOut.writeFloat(seqArr(seqCnt))
		Next seqCnt
		Exit Sub
ErrHandler: 
		Call mVBOrb.VBOrb.ErrReraise(Err, "SingleSeq.write")
	End Sub
...
ErrHandler: 
	...
	Public Sub insertIntoAny(ByVal oAny As cOrbAny)
		...
		Dim seqCnt As Integer
		For seqCnt = 0 To seqLen - 1
			Call oAny.insertFloat(seqArr(seqCnt))
			Call oAny.nextPos()
		Next seqCnt
		Call oAny.rewind()
		Exit Sub
