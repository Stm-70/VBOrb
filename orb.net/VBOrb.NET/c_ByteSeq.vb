Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("c_ByteSeq_NET.c_ByteSeq")> Public Class c_ByteSeq
	Implements _cOrbValueBase
	'Generated by IDL2VB v123. Copyright (c) 1999-2003 Martin.Both
	'Source File Name: ../include/CORBA.idl
	'Target File Name: c_ByteSeq.cls
	
	
	
	'IDL Name: sequence<octet>
	'valuetype ::org::omg::boxedRMI::seq1_octet
	Const sTypeId As String = "RMI:[B:0000000000000000"
	...
	Public Property Length() As Integer
		...
		Set(ByVal Value As Integer)
			...
			Exit Property
ErrHandler: 
			Call mVBOrb.VBOrb.ErrReraise(Err, "ByteSeq.Length.Let")
		End Set
	End Property
	...
	Public Property Item(ByVal index As Integer) As Byte
		Get
			...
			Exit Property
ErrHandler: 
			Call mVBOrb.VBOrb.ErrReraise(Err, "ByteSeq.Item.Get")
		End Get
		Set(ByVal Value As Byte)
			...
			Exit Property
ErrHandler: 
			Call mVBOrb.VBOrb.ErrReraise(Err, "ByteSeq.Item.Let")
		End Set
	End Property
...
ErrHandler: 
	...
	Public Sub initByRead(ByVal oIn As cOrbStream, ByVal maxLen As Integer)
		...
		Exit Sub
ErrHandler: 
		Call mVBOrb.VBOrb.ErrReraise(Err, "ByteSeq.read")
	End Sub
	...
	Public Sub writeMe(ByVal oOut As cOrbStream, ByVal maxLen As Integer)
		...
		Call oOut.writeOctets(seqArr, seqLen)
		Exit Sub
ErrHandler: 
		Call mVBOrb.VBOrb.ErrReraise(Err, "ByteSeq.write")
	End Sub
...
ErrHandler: 
	...
	Public Sub insertIntoAny(ByVal oAny As cOrbAny)
		...
		Dim seqCnt As Integer
		For seqCnt = 0 To seqLen - 1
			Call oAny.insertOctet(seqArr(seqCnt))
			Call oAny.nextPos()
		Next seqCnt
		Call oAny.rewind()
		Exit Sub
