Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("cCBUnionMemberSeq_NET.cCBUnionMemberSeq")> Public Class cCBUnionMemberSeq
	'Generated by IDL2VB v123. Copyright (c) 1999-2003 Martin.Both
	'Source File Name: ../include/CORBA.idl
	'Target File Name: cCBUnionMemberSeq.cls
	
	
	'IDL Name: sequence<::CORBA::UnionMember>
	
	Private seqLen As Integer
	Private seqBnd As Integer
	Private seqArr() As cCBUnionMember
	...
	Public Property Length() As Integer
		...
		Set(ByVal Value As Integer)
			...
			Exit Property
ErrHandler: 
			Call mVBOrb.VBOrb.ErrReraise(Err, "CBUnionMemberSeq.Length.Let")
		End Set
	End Property
	...
	'index must be in the range of 0 to Length - 1
	Public Property Item(ByVal index As Integer) As cCBUnionMember
		Get
			On Error GoTo ErrHandler
			Item = seqArr(index)
			Exit Property
ErrHandler: 
			Call mVBOrb.VBOrb.ErrReraise(Err, "CBUnionMemberSeq.Item.Get")
		End Get
		Set(ByVal Value As cCBUnionMember)
			On Error GoTo ErrHandler
			seqArr(index) = Value
			Exit Property
ErrHandler: 
			Call mVBOrb.VBOrb.ErrReraise(Err, "CBUnionMemberSeq.Item.Set")
		End Set
	End Property
	
	Public Function getItems(ByRef Arr() As cCBUnionMember) As Integer
		On Error GoTo ErrHandler
		getItems = seqLen
...
ErrHandler: 
	...
	Public Sub setItems(ByRef Arr() As cCBUnionMember, ByVal newLen As Integer)
		On Error GoTo ErrHandler
		Me.Length = newLen
		Dim seqCnt As Integer
		For seqCnt = 0 To seqLen - 1
...
ErrHandler: 
	...
	Public Sub initByRead(ByVal oIn As cOrbStream, ByVal maxLen As Integer)
		...
		Dim seqCnt As Integer
		For seqCnt = 0 To seqLen - 1
			seqArr(seqCnt) = New cCBUnionMember
			Call seqArr(seqCnt).initByRead(oIn)
		Next seqCnt
		Exit Sub
ErrHandler: 
		Call mVBOrb.VBOrb.ErrReraise(Err, "CBUnionMemberSeq.read")
	End Sub
	...
	Public Sub writeMe(ByVal oOut As cOrbStream, ByVal maxLen As Integer)
		...
		Exit Sub
ErrHandler: 
		Call mVBOrb.VBOrb.ErrReraise(Err, "CBUnionMemberSeq.write")
	End Sub
