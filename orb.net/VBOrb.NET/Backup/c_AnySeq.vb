Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("c_AnySeq_NET.c_AnySeq")> Public Class c_AnySeq
	Implements _cOrbValueBase
	'Generated by IDL2VB v123. Copyright (c) 1999-2003 Martin.Both
	'Source File Name: ../include/CORBA.idl
	'Target File Name: c_AnySeq.cls
	
	
	
	'IDL Name: sequence<any>
	'valuetype ::org::omg::boxedRMI::java::lang::seq1_Object
	Const sTypeId As String = "RMI:[Ljava.lang.Object;:0000000000000000"
	
	Private seqLen As Integer
	Private seqBnd As Integer
	Private seqArr() As cOrbAny
	...
	Public Property Length() As Integer
		...
		Set(ByVal Value As Integer)
			...
			Exit Property
ErrHandler: 
			Call mVBOrb.VBOrb.ErrReraise(Err, "AnySeq.Length.Let")
		End Set
	End Property
	...
	'index must be in the range of 0 to Length - 1
	Public Property Item(ByVal index As Integer) As cOrbAny
		Get
			On Error GoTo ErrHandler
			Item = seqArr(index)
			Exit Property
ErrHandler: 
			Call mVBOrb.VBOrb.ErrReraise(Err, "AnySeq.Item.Get")
		End Get
		Set(ByVal Value As cOrbAny)
			...
			Exit Property
ErrHandler: 
			Call mVBOrb.VBOrb.ErrReraise(Err, "AnySeq.Item.Set")
		End Set
	End Property
	
	Public Function getItems(ByRef Arr() As cOrbAny) As Integer
		On Error GoTo ErrHandler
		getItems = seqLen
...
ErrHandler: 
	...
	Public Sub setItems(ByRef Arr() As cOrbAny, ByVal newLen As Integer)
		On Error GoTo ErrHandler
		Me.Length = newLen
		Dim seqCnt As Integer
		For seqCnt = 0 To seqLen - 1
...
ErrHandler: 
	...
	Public Sub initByRead(ByVal oIn As cOrbStream, ByVal maxLen As Integer)
		...
		Dim seqCnt As Integer
		For seqCnt = 0 To seqLen - 1
			seqArr(seqCnt) = oIn.readAny()
		Next seqCnt
		Exit Sub
ErrHandler: 
		Call mVBOrb.VBOrb.ErrReraise(Err, "AnySeq.read")
	End Sub
	...
	Public Sub writeMe(ByVal oOut As cOrbStream, ByVal maxLen As Integer)
		...
		Dim seqCnt As Integer
		For seqCnt = 0 To seqLen - 1
			Call oOut.writeAny(seqArr(seqCnt))
		Next seqCnt
		Exit Sub
ErrHandler: 
		Call mVBOrb.VBOrb.ErrReraise(Err, "AnySeq.write")
	End Sub
...
ErrHandler: 
	...
	Public Sub insertIntoAny(ByVal oAny As cOrbAny)
		...
		Dim seqCnt As Integer
		For seqCnt = 0 To seqLen - 1
			Call oAny.insertAny(seqArr(seqCnt))
			Call oAny.nextPos()
		Next seqCnt
		Call oAny.rewind()
		Exit Sub
