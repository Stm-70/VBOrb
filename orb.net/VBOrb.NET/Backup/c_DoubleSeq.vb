Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("c_DoubleSeq_NET.c_DoubleSeq")> Public Class c_DoubleSeq
...
ErrHandler: 
	...
	'index must be in the range of 0 to Length - 1
	Public Property Item(ByVal index As Integer) As Double
		Get
			On Error GoTo ErrHandler
			Item = seqArr(index)
			Exit Property
...
ErrHandler: 
	...
	Public Function getItems(ByRef Arr() As Double) As Integer
		On Error GoTo ErrHandler
		getItems = seqLen
...
ErrHandler: 
	...
	Public Sub setItems(ByRef Arr() As Double, ByVal newLen As Integer)
		On Error GoTo ErrHandler
		Me.Length = newLen
		Dim seqCnt As Integer
		For seqCnt = 0 To seqLen - 1
