Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("c_WcharSeq_NET.c_WcharSeq")> Public Class c_WcharSeq
	'Generated by IDL2VB v123. Copyright (c) 1999-2003 Martin.Both
	'Source File Name: ../include/CORBA.idl
	'Target File Name: c_WcharSeq.cls
...
ErrHandler: 
	...
	Public Sub insertIntoAny(ByVal oAny As cOrbAny)
		...
		Dim seqCnt As Integer
		For seqCnt = 0 To seqLen - 1
			Call oAny.insertWchar(seqArr(seqCnt))
			Call oAny.nextPos()
		Next seqCnt
		Call oAny.rewind()
		Exit Sub
