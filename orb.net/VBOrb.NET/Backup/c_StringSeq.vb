Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("c_StringSeq_NET.c_StringSeq")> Public Class c_StringSeq
	'Generated by IDL2VB v123. Copyright (c) 1999-2003 Martin.Both
	'Source File Name: ../include/CORBA.idl
	'Target File Name: c_StringSeq.cls
	
	
	'IDL Name: sequence<string>
	...
	Public Property Length() As Integer
		...
		Set(ByVal Value As Integer)
			...
			Exit Property
ErrHandler: 
			Call mVBOrb.VBOrb.ErrReraise(Err, "StringSeq.Length.Let")
		End Set
	End Property
	...
	Public Property Item(ByVal index As Integer) As String
		Get
			...
			Exit Property
ErrHandler: 
			Call mVBOrb.VBOrb.ErrReraise(Err, "StringSeq.Item.Get")
		End Get
		Set(ByVal Value As String)
			...
			Exit Property
ErrHandler: 
			Call mVBOrb.VBOrb.ErrReraise(Err, "StringSeq.Item.Let")
		End Set
	End Property
...
ErrHandler: 
	...
	Public Sub initByRead(ByVal oIn As cOrbStream, ByVal maxLen As Integer)
		...
		Dim seqCnt As Integer
		For seqCnt = 0 To seqLen - 1
			seqArr(seqCnt) = oIn.readString()
		Next seqCnt
		Exit Sub
ErrHandler: 
		Call mVBOrb.VBOrb.ErrReraise(Err, "StringSeq.read")
	End Sub
	...
	Public Sub writeMe(ByVal oOut As cOrbStream, ByVal maxLen As Integer)
		...
		Dim seqCnt As Integer
		For seqCnt = 0 To seqLen - 1
			Call oOut.writeString(seqArr(seqCnt))
		Next seqCnt
		Exit Sub
ErrHandler: 
		Call mVBOrb.VBOrb.ErrReraise(Err, "StringSeq.write")
	End Sub
...
ErrHandler: 
	...
	Public Sub insertIntoAny(ByVal oAny As cOrbAny)
		...
		Dim seqCnt As Integer
		For seqCnt = 0 To seqLen - 1
			Call oAny.insertString(seqArr(seqCnt))
			Call oAny.nextPos()
		Next seqCnt
		Call oAny.rewind()
		Exit Sub
