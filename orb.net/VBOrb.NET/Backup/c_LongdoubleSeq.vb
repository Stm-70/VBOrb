Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("c_LongdoubleSeq_NET.c_LongdoubleSeq")> Public Class c_LongdoubleSeq
	'Generated by IDL2VB v123. Copyright (c) 1999-2003 Martin.Both
	'Source File Name: ../include/CORBA.idl
	'Target File Name: c_LongdoubleSeq.cls
	
	
	'IDL Name: sequence<long double>
	
	Private seqLen As Integer
	Private seqBnd As Integer
	Private seqArr() As cOrblongdouble
	...
	Public Property Length() As Integer
		...
		Set(ByVal Value As Integer)
			...
			Exit Property
ErrHandler: 
			Call mVBOrb.VBOrb.ErrReraise(Err, "LongdoubleSeq.Length.Let")
		End Set
	End Property
	...
	'index must be in the range of 0 to Length - 1
	Public Property Item(ByVal index As Integer) As cOrblongdouble
		Get
			On Error GoTo ErrHandler
			Item = seqArr(index)
			Exit Property
ErrHandler: 
			Call mVBOrb.VBOrb.ErrReraise(Err, "LongdoubleSeq.Item.Get")
		End Get
		Set(ByVal Value As cOrblongdouble)
			On Error GoTo ErrHandler
			seqArr(index) = Value
			Exit Property
ErrHandler: 
			Call mVBOrb.VBOrb.ErrReraise(Err, "LongdoubleSeq.Item.Set")
		End Set
	End Property
	
	Public Function getItems(ByRef Arr() As cOrblongdouble) As Integer
		On Error GoTo ErrHandler
		getItems = seqLen
...
ErrHandler: 
	...
	Public Sub setItems(ByRef Arr() As cOrblongdouble, ByVal newLen As Integer)
		On Error GoTo ErrHandler
		Me.Length = newLen
		Dim seqCnt As Integer
		For seqCnt = 0 To seqLen - 1
...
ErrHandler: 
	...
	Public Sub initByRead(ByVal oIn As cOrbStream, ByVal maxLen As Integer)
		...
		Dim seqCnt As Integer
		For seqCnt = 0 To seqLen - 1
			seqArr(seqCnt) = oIn.readLongdouble()
		Next seqCnt
		Exit Sub
ErrHandler: 
		Call mVBOrb.VBOrb.ErrReraise(Err, "LongdoubleSeq.read")
	End Sub
	...
	Public Sub writeMe(ByVal oOut As cOrbStream, ByVal maxLen As Integer)
		...
		Dim seqCnt As Integer
		For seqCnt = 0 To seqLen - 1
			Call oOut.writeLongdouble(seqArr(seqCnt))
		Next seqCnt
		Exit Sub
ErrHandler: 
		Call mVBOrb.VBOrb.ErrReraise(Err, "LongdoubleSeq.write")
	End Sub
	...
	Public Sub initByAny(ByVal oAny As cOrbAny)
		...
		Dim seqCnt As Integer
		For seqCnt = 0 To seqLen - 1
			seqArr(seqCnt) = oAny.getLongdouble()
			Call oAny.nextPos()
		Next seqCnt
		Call oAny.rewind()
		Exit Sub
ErrHandler: 
	...
	Public Sub insertIntoAny(ByVal oAny As cOrbAny)
		...
		Dim seqCnt As Integer
		For seqCnt = 0 To seqLen - 1
			Call oAny.insertLongdouble(seqArr(seqCnt))
			Call oAny.nextPos()
		Next seqCnt
		Call oAny.rewind()
		Exit Sub
