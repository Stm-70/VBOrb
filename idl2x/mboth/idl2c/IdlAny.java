 ...
 *  @author  Martin Both
 */
public class IdlAny extends IdlIdentifier implements IdlType
{
 /** Read a <any_type>
	 *
	 ...
	 */
 public static IdlAny readIdlAny(IdlScope idlScope,
  TxtFilePos filePos)
 { return new IdlAny(idlScope, filePos);
 }
 /**
	 *  @param	surScope	Surrounding scope, IdlSpecification or null
	 *  @param	filePos		File position of the identifier
	 */
 protected IdlAny(IdlScope surScope, TxtFilePos filePos)
 { super(surScope, IdlSpecification.ANY, filePos);
 }
 ...
 { //if(withPrefix)
   return CWriter.CORBA_ + IdlSpecification.ANY;
  //return IdlSpecification.ANY;
 }
}
