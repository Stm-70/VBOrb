...
public class IdlString extends IdlIdentifier implements IdlConstType
{
 ...
 { if(wide)
  { //if(withPrefix)
    return CWriter.CORBA_ + IdlSpecification.WSTRING;
   //return IdlSpecification.WSTRING;
  }else
  { //if(withPrefix)
    return CWriter.CORBA_ + IdlSpecification.STRING;
   //return IdlSpecification.STRING;
  }
 }
}
