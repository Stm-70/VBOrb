...
public class IdlFixed extends IdlIdentifier implements IdlConstType
{
 ...
 { /*if(scale >= 0)
			sVbName= getUnEscName() + digits + "s" + scale;
		else
			sVbName= getUnEscName() + digits + "sn" + (-scale);
		*/
   ...
   throws java.io.IOException
 {
  ...
  // mCB.tk_fixed = 28
  out.writeLine("oOrb.createPrimitiveTc(28) 'VBOrb.TCFixed");
 }
 /** (IdlType)
   ...
   throws java.io.IOException
 {
  ...
  out.writeLine(VbWriter.OANY + "." + "getFixed" + "()");
 }
 /** (IdlType)
