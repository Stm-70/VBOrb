Attribute VB_Name = "mCBLocalInterfaceDef"
...
Public Const TypeId As String = "IDL:omg.org/CORBA/LocalInterfaceDef:1.0"

'Helper
Public Function narrow(ByVal Obj As cOrbObject) As cCBLocalInterfaceDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
        Set narrow = Nothing
    Else
        Dim oObj As cOrbObject
        Set oObj = New cCBLocalInterfaceDef
...
'Helper
Public Function uncheckedNarrow(ByVal Obj As cOrbObject) As cCBLocalInterfaceDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
