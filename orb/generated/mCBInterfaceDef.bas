Attribute VB_Name = "mCBInterfaceDef"
...
Public Const TypeId As String = "IDL:omg.org/CORBA/InterfaceDef:1.0"

'Helper
Public Function narrow(ByVal Obj As cOrbObject) As cCBInterfaceDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
        Set narrow = Nothing
    Else
        Dim oObj As cOrbObject
        Set oObj = New cCBInterfaceDef
...
'Helper
Public Function uncheckedNarrow(ByVal Obj As cOrbObject) As cCBInterfaceDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
