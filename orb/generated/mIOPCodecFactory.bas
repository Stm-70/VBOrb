Attribute VB_Name = "mIOPCodecFactory"
...
Public Const TypeId As String = "IDL:omg.org/IOP/CodecFactory:1.0"

'Helper
Public Function narrow(ByVal Obj As cOrbObject) As cIOPCodecFactory
...
'Helper
Public Function uncheckedNarrow(ByVal Obj As cOrbObject) As cIOPCodecFactory
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
