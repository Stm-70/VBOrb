Attribute VB_Name = "mCBValueBoxDef"
...
Public Const TypeId As String = "IDL:omg.org/CORBA/ValueBoxDef:1.0"

'Helper
Public Function narrow(ByVal Obj As cOrbObject) As cCBValueBoxDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
        Set narrow = Nothing
    Else
        Dim oObj As cOrbObject
        Set oObj = New cCBValueBoxDef
...
'Helper
Public Function uncheckedNarrow(ByVal Obj As cOrbObject) As cCBValueBoxDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
