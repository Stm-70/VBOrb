Attribute VB_Name = "mCBConstantDef"
...
Public Const TypeId As String = "IDL:omg.org/CORBA/ConstantDef:1.0"

'Helper
Public Function narrow(ByVal Obj As cOrbObject) As cCBConstantDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
        Set narrow = Nothing
    Else
        Dim oObj As cOrbObject
        Set oObj = New cCBConstantDef
...
'Helper
Public Function uncheckedNarrow(ByVal Obj As cOrbObject) As cCBConstantDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
