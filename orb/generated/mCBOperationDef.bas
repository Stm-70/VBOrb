Attribute VB_Name = "mCBOperationDef"
...
Public Const TypeId As String = "IDL:omg.org/CORBA/OperationDef:1.0"

'Helper
Public Function narrow(ByVal Obj As cOrbObject) As cCBOperationDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
        Set narrow = Nothing
    Else
        Dim oObj As cOrbObject
        Set oObj = New cCBOperationDef
...
'Helper
Public Function uncheckedNarrow(ByVal Obj As cOrbObject) As cCBOperationDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
