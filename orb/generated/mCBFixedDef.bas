Attribute VB_Name = "mCBFixedDef"
'Generated by IDL2VB v123. Copyright (c) 2000-2003 Martin.Both
'Source File Name: ../include/CORBA.idl

Option Explicit

'interface ::CORBA::FixedDef
Public Const TypeId As String = "IDL:omg.org/CORBA/FixedDef:1.0"

'Helper
Public Function narrow(ByVal Obj As cOrbObject) As cCBFixedDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
        Set narrow = Nothing
    Else
        Dim oObj As cOrbObject
        Set oObj = New cCBFixedDef
...
'Helper
Public Function uncheckedNarrow(ByVal Obj As cOrbObject) As cCBFixedDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
