...
Public Const TypeId As String = "IDL:omg.org/CORBA/EnumDef:1.0"

'Helper
Public Function narrow(ByVal Obj As cOrbObject) As cCBEnumDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
        Set narrow = Nothing
    Else
        Dim oObj As cOrbObject
        Set oObj = New cCBEnumDef
...
'Helper
Public Function uncheckedNarrow(ByVal Obj As cOrbObject) As cCBEnumDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
