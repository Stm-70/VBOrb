Attribute VB_Name = "mCBExceptionDescription"
...
Public Const TypeId As String = "IDL:omg.org/CORBA/ExceptionDescription:1.0"
...
Public Function TypeCode() As cOrbTypeCode
    ...
    If oRecTC Is Nothing Then
        ...
        Call oRecTC.setRecTc2StructTc("ExceptionDescription", oMemSeq)
    End If
    Set TypeCode = oRecTC
    Exit Function
ErrRollback:
...
Public Function extractFromAny(ByVal oAny As cOrbAny) As cCBExceptionDescription
    Dim oStruct As cCBExceptionDescription
    Set oStruct = New cCBExceptionDescription
    Call oStruct.initByAny(oAny)
    Set extractFromAny = oStruct
End Function

'Helper, struct.writeMe() -> oAny.initByReadValue()
Public Function cloneAsAny(ByVal oStruct As cCBExceptionDescription) As cOrbAny
    On Error GoTo ErrHandler
    Dim oAny As cOrbAny
