Attribute VB_Name = "mCBExceptionDef"
...
Public Const TypeId As String = "IDL:omg.org/CORBA/ExceptionDef:1.0"

'Helper
Public Function narrow(ByVal Obj As cOrbObject) As cCBExceptionDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
        Set narrow = Nothing
    Else
        Dim oObj As cOrbObject
        Set oObj = New cCBExceptionDef
...
'Helper
Public Function uncheckedNarrow(ByVal Obj As cOrbObject) As cCBExceptionDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
