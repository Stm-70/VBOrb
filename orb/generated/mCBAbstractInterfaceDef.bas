Attribute VB_Name = "mCBAbstractInterfaceDef"
...
Public Const TypeId As String = "IDL:omg.org/CORBA/AbstractInterfaceDef:1.0"

'Helper
Public Function narrow(ByVal Obj As cOrbObject) As cCBAbstractInterfaceDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
        Set narrow = Nothing
    Else
        Dim oObj As cOrbObject
        Set oObj = New cCBAbstractInterfaceDef
