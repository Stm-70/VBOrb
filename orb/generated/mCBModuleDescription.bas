Attribute VB_Name = "mCBModuleDescription"
...
Public Const TypeId As String = "IDL:omg.org/CORBA/ModuleDescription:1.0"
...
Public Function TypeCode() As cOrbTypeCode
    ...
    If oRecTC Is Nothing Then
        ...
        Call oRecTC.setRecTc2StructTc("ModuleDescription", oMemSeq)
    End If
    Set TypeCode = oRecTC
    Exit Function
ErrRollback:
...
Public Function extractFromAny(ByVal oAny As cOrbAny) As cCBModuleDescription
    Dim oStruct As cCBModuleDescription
    Set oStruct = New cCBModuleDescription
    Call oStruct.initByAny(oAny)
    Set extractFromAny = oStruct
End Function

'Helper, struct.writeMe() -> oAny.initByReadValue()
Public Function cloneAsAny(ByVal oStruct As cCBModuleDescription) As cOrbAny
    On Error GoTo ErrHandler
    Dim oAny As cOrbAny
