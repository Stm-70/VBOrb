Attribute VB_Name = "mCBContainer"
...
Public Const TypeId As String = "IDL:omg.org/CORBA/Container:1.0"

'Helper
Public Function narrow(ByVal Obj As cOrbObject) As cCBContainer
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
        Set narrow = Nothing
    Else
        Dim oObj As cOrbObject
        Set oObj = New cCBContainer
...
'Helper
Public Function uncheckedNarrow(ByVal Obj As cOrbObject) As cCBContainer
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
