Attribute VB_Name = "mCBAttributeDef"
...
Public Const TypeId As String = "IDL:omg.org/CORBA/AttributeDef:1.0"

'Helper
Public Function narrow(ByVal Obj As cOrbObject) As cCBAttributeDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
        Set narrow = Nothing
    Else
        Dim oObj As cOrbObject
        Set oObj = New cCBAttributeDef
...
'Helper
Public Function uncheckedNarrow(ByVal Obj As cOrbObject) As cCBAttributeDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
