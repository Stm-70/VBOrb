Attribute VB_Name = "mCBTypedefDef"
...
Public Const TypeId As String = "IDL:omg.org/CORBA/TypedefDef:1.0"

'Helper
Public Function narrow(ByVal Obj As cOrbObject) As cCBTypedefDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
        Set narrow = Nothing
    Else
        Dim oObj As cOrbObject
        Set oObj = New cCBTypedefDef
...
'Helper
Public Function uncheckedNarrow(ByVal Obj As cOrbObject) As cCBTypedefDef
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
