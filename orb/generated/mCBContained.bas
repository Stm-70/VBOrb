Attribute VB_Name = "mCBContained"
...
Public Const TypeId As String = "IDL:omg.org/CORBA/Contained:1.0"

'Helper
Public Function narrow(ByVal Obj As cOrbObject) As cCBContained
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
        Set narrow = Nothing
    Else
        Dim oObj As cOrbObject
        Set oObj = New cCBContained
...
'Helper
Public Function uncheckedNarrow(ByVal Obj As cOrbObject) As cCBContained
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
