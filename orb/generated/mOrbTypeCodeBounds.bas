Attribute VB_Name = "mOrbTypeCodeBounds"
...
Public Const TypeId As String = "IDL:omg.org/CORBA/TypeCode/Bounds:1.0"
...
Public Function TypeCode() As cOrbTypeCode
    ...
    If oRecTC Is Nothing Then
        ...
        Call oRecTC.setRecTc2ExceptionTc("Bounds", oMemSeq)
    End If
    Set TypeCode = oRecTC
    Exit Function
ErrRollback:
...
Public Function extractFromAny(ByVal oAny As cOrbAny) As cOrbTypeCodeBounds
    Dim oException As cOrbTypeCodeBounds
    Set oException = New cOrbTypeCodeBounds
    Call oException.initByAny(oAny)
    Set extractFromAny = oException
End Function

'Helper, exception.writeMe() -> oAny.initByReadValue()
Public Function cloneAsAny(ByVal oException As cOrbTypeCodeBounds) As cOrbAny
    On Error GoTo ErrHandler
    Dim oAny As cOrbAny
